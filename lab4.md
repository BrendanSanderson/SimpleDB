# 23500 Lab 4: SimpleDB Transactions

### Graduating Seniors MUST turn in this assignment by the Friday of the reading period at the latest (i.e. you are capped on your slack days)###
...
to do this is to change to your project directory, set up the branch,
and pull from the master GitHub repository:

```
$ git checkout -b lab4
$ git pull upstream lab4
...
**Bonus Exercise 6. (10% extra credit max)**
...
You may continue to work with your partner on this assignment.
...
Place the write-up in a file called <tt>lab4-writeup.txt</tt> in the top level of your <tt>simple-db-hw</tt> directory.  **Important:**
...
files. After you've added and committed your changes locally, you can submit your code using
chisubmit for lab4.
