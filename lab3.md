...
cost-based optimizer discussed in class (see <a
 href="http://people.cs.uchicago.edu/~aelmore/class/selinger.pdf">these
...
Translating the algorithm given in <a href="http://people.cs.uchicago.edu/~aelmore/class/selinger.pdf">these
...
memory hashing using a <tt>HashMap</tt>). We have provided a template for a hashjoin in HashEquiJoin.java 
