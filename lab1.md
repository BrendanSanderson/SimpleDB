...
**Start by downloading the code for lab 1 from the course GitLab repository by following the 
 instructions [here](https://mit.cs.uchicago.edu/cmsc23500-win-19/cmsc23500-win-19).**
...
You may also wish to consult the [JavaDoc](http://people.cs.uchicago.edu/~aelmore/class/javadoc/) for SimpleDB.
...
are iterator based; each operator implements the `OpIterator`
interface.
...
Place the write-up in a file called <tt>lab1-writeup.txt</tt>  in the simpledb folder of your <tt>cmsc23500-win-19</tt> directory.  
