...
**Eclipse users** may need to take one more step for their code to compile.
...
Undergraduates will work on the same team that they used for lab1 or can split to work individually.
